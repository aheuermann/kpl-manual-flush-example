...
public class KplManualFlushExample {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            try {
                ...
                allFutures.get();
                LOGGER.info("Done publishing batch [batchNumber={}, size={}, duration={}ms]", batchCount, futures.size(), System.currentTimeMillis() - startTime);
    ...
    private static KinesisProducer buildKPL() {
        KinesisProducerConfiguration config = new KinesisProducerConfiguration()
                ...
                .setRecordMaxBufferedTime(10000L)
